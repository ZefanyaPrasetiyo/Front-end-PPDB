  ...
  return (
    <div className="w-full py-20 bg-gradient-to-b from-[#f4f7fb] to-[#e9eef6]">
      ...
      <div className="max-w-4xl mx-auto text-center mb-16 px-6">
        ...
        <p className="text-lg text-[#4A88C7]/80 max-w-2xl mx-auto">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 px-6">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border border-blue-100 hover:shadow-xl hover:border-blue-200 transition-all duration-300 flex flex-col h-fit">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-[#4A88C7] font-medium">
          ...
          <div className="space-y-4 flex-1">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-[#173E67]">Gedung Sarpras Sekolah:</span>
                <span className="font-semibold text-blue-900">Rp 1.800.000</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-[#173E67]">Dana Praktek Siswa:</span>
                <span className="font-semibold text-blue-900">Rp 700.000</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-[#173E67]">Administrasi & Kegiatan:</span>
                <span className="font-semibold text-blue-900">Rp 800.000</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-[#173E67]">Seragam Kejuruan & Olahraga:</span>
                <span className="font-semibold text-blue-900">Rp 400.000</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-[#173E67]">Iuran Pendidikan Juli 2026:</span>
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <h5 className="font-semibold text-[#173E67] text-sm mb-3">
                Pembelian Terpisah di Koperasi TB:
              </h5>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between items-center">
                  <span className="text-[#4A88C7]">Kemeja Biru:</span>
                  <span className="font-semibold text-[#173E67]">Rp 150.000</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#4A88C7]">Seragam Jurusan:</span>
                  <span className="font-semibold text-[#173E67]">Rp 150.000</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-[#4A88C7]">Dasi & Atribut:</span>
                  <span className="font-semibold text-[#173E67]">Rp 150.000</span>
                </div>
              </div>
              <div className="mt-3 pt-3 border-t border-blue-300">
                <div className="flex justify-between items-center font-semibold text-[#173E67]">
